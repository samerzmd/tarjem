...
class Settings:
    ...
    register: str = os.getenv("ARABIC_REGISTER", "msa")
    output_suffix: str = os.getenv("OUTPUT_SUFFIX", ".ar.srt")
    ...
    effort: str = os.getenv("LLM_EFFORT", "low")
    ...
    # --- integrations ----------------------------------------------------
    bazarr_url: str = os.getenv("BAZARR_URL", "http://bazarr:6767").rstrip("/")
    bazarr_api_key: str = os.getenv("BAZARR_API_KEY", "")
    notify_bazarr: bool = _bool("NOTIFY_BAZARR", True)
    whisper_url: str = os.getenv("WHISPER_URL", "").rstrip("/")
    ...
    sweep_source: str = os.getenv("SWEEP_SOURCE", "bazarr")  # bazarr | disk
